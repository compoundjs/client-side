...
var WebServiceAdapter = require('jugglingdb/lib/adapters/http');

exports.init = function (compound) {
    // load models and schema
    var schema = new Schema(compound.app.get('schema adapter') || WebServiceAdapter);
    var fn = new Function('context', 'require', 'with(context){(function(){' + window.files[compound.root + '/db/schema.js'] + '})()}');
